...
THREE.FirstPersonControls = function ( object, domElement ) {
	...
	this.object = object;
	this.target = new THREE.Vector3( 7000,23000,17000 );
  ...
  //       this.object.position.x= camera_initial_position.x;
  //       this.object.position.y = camera_initial_position.y;
  //       this.object.position.z = camera_initial_position.z;
  ...
  //   };
	...
	this.onMouseMove = function ( event ) {
	 ...
	 this.onSpacePressed = function(event){
